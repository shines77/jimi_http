...
namespace DictionayLib
{
    ...
    public class DictionaryEx<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary,
                                              IReadOnlyDictionary<TKey, TValue>, ISerializable,
                                              IDeserializationCallback
    {
        ...
        public DictionaryEx() : this(0, null) { }

        public DictionaryEx(int capacity) : this(capacity, null) { }

        public DictionaryEx(IEqualityComparer<TKey> comparer) : this(0, comparer) { }
        ...
        public DictionaryEx(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }
